...
module.exports.admin = async(req,res)=>{
    try{
        // getting list of all users with role as Employee
...
module.exports.deleteEmployee = async(req,res)=>{
    try{
        ...
        await Feedback.deleteMany({reviwer:id});
...
// routes for rendering the update data form
module.exports.updateForm = async(req,res)=>{
    ...
    // pass the list of feedbacks given to employees by others
...
module.exports.addEmployee = async(req,res,next)=>{
    try{
        ...
        if(!userExist){
            ...
            // if password match ,encrypt the password
...
// router to assign a review to any employee
module.exports.assignReview = async(req,res)=>{
    ...
    // if employee found
    // check whether the user already has a recipient in his assign review list
